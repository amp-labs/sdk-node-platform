...
```typescript
import { UpdateInstallationInstallationsDefaultPeriodConfig } from "@amp-labs/sdk-node-platform/models/operations";

let value: UpdateInstallationInstallationsDefaultPeriodConfig = {
  days: 30,
  fullHistory: false,
};
```
