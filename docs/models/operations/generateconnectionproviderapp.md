...
```typescript
import { GenerateConnectionProviderApp } from "@amp-labs/sdk-node-platform/models/operations";

let value: GenerateConnectionProviderApp = {
  id: "provider-app-123",
  ...
  createTime: new Date("2024-10-27T00:55:36.793Z"),
};
```
