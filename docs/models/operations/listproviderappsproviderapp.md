...
```typescript
import { ListProviderAppsProviderApp } from "@amp-labs/sdk-node-platform/models/operations";

let value: ListProviderAppsProviderApp = {
  id: "provider-app-123",
  ...
  createTime: new Date("2024-06-04T17:54:53.015Z"),
};
```
