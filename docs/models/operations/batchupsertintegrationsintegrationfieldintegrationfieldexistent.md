...
```typescript
import { BatchUpsertIntegrationsIntegrationFieldIntegrationFieldExistent } from "@amp-labs/sdk-node-platform/models/operations";

let value: BatchUpsertIntegrationsIntegrationFieldIntegrationFieldExistent = {
  fieldName: "<value>",
