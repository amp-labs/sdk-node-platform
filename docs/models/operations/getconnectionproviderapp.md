...
```typescript
import { GetConnectionProviderApp } from "@amp-labs/sdk-node-platform/models/operations";

let value: GetConnectionProviderApp = {
  id: "provider-app-123",
  ...
  createTime: new Date("2024-10-01T18:52:28.332Z"),
};
```
