...
```typescript
import { UpdateInstallationProviderApp } from "@amp-labs/sdk-node-platform/models/operations";

let value: UpdateInstallationProviderApp = {
  id: "provider-app-123",
  ...
  createTime: new Date("2024-06-16T23:18:45.433Z"),
};
```
