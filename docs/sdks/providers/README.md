...
* [list](#list) - List providers
* [get](#get) - Get provider
...
async function run() {
  const result = await sdkNodePlatform.providers.list();
...
import { providersList } from "@amp-labs/sdk-node-platform/funcs/providersList.js";
...
async function run() {
  const res = await providersList(sdkNodePlatform);
...
async function run() {
  const result = await sdkNodePlatform.providers.get({
    provider: "hubspot",
  });
...
```typescript
import { SDKNodePlatformCore } from "@amp-labs/sdk-node-platform/core.js";
import { providersGet } from "@amp-labs/sdk-node-platform/funcs/providersGet.js";
...
async function run() {
  const res = await providersGet(sdkNodePlatform, {
    provider: "hubspot",
  });
...
**Promise\<[operations.GetProviderResponse](../../models/operations/getproviderresponse.md)\>**
