...
async function run() {
  const result = await sdkNodePlatform.projects.list();
...
async function run() {
  const res = await projectsList(sdkNodePlatform);
...
async function run() {
  const result = await sdkNodePlatform.projects.create({
    appName: "MailMonkey",
...
async function run() {
  const res = await projectsCreate(sdkNodePlatform, {
    appName: "MailMonkey",
    name: "mailmonkey-staging",
    orgId: "9f7c3e2a-61b8-4f5c-8d1a-eb24f3b05d79",
  });
...
async function run() {
  const result = await sdkNodePlatform.projects.get({
...
async function run() {
  const res = await projectsGet(sdkNodePlatform, {
    projectIdOrName: "my-project",
  });
...
async function run() {
  const result = await sdkNodePlatform.projects.delete({
    projectIdOrName: "my-project",
  });
...
async function run() {
  const res = await projectsDelete(sdkNodePlatform, {
    projectIdOrName: "my-project",
  });
...
async function run() {
  const result = await sdkNodePlatform.projects.update({
    projectIdOrName: "my-project",
    requestBody: {
      updateMask: [
        "appName",
...
async function run() {
  const res = await projectsUpdate(sdkNodePlatform, {
    projectIdOrName: "my-project",
    requestBody: {
      updateMask: [
        "appName",
