...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *sdk-node-platform* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=sdk-node-platform&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/ampersand/ts). Delete this section before > publishing to a package manager.
...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [sdk-node-platform](#sdk-node-platform)
...
import {
  ...
  SDKValidationError,
} from "sdk-node-platform/models/errors";
...
```typescript
import { SDKNodePlatform } from "sdk-node-platform";
import { HTTPClient } from "sdk-node-platform/lib/http";
