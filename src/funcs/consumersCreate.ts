 ...
 */
export async function consumersCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateConsumerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/projects/{projectIdOrName}/consumers")(pathParams);
