 ...
 */
export function installationPauseReads(
  client: SDKNodePlatformCore,
  request: operations.PauseReadsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PauseReadsAPIProblem | undefined,
    | errors.PauseReadsInputValidationProblem
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PauseReadsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.PauseReadsAPIProblem$inboundSchema.optional()),
    M.jsonErr(400, errors.PauseReadsInputValidationProblem$inboundSchema, {
    ...
    M.json(
      "default",
      operations.PauseReadsAPIProblem$inboundSchema.optional(),
      { ctype: "application/problem+json" },
    ),
