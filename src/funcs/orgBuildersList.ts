 ...
 */
export function orgBuildersList(
  ...
  Result<
    operations.ListOrgBuildersResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListOrgBuildersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/orgs/{orgId}/builders")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListOrgBuildersResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.ListOrgBuildersResponse$inboundSchema, {
