 ...
 */
export function installationUnpauseReads(
  client: SDKNodePlatformCore,
  request: operations.UnpauseReadsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UnpauseReadsAPIProblem | undefined,
    | errors.UnpauseReadsInputValidationProblem
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UnpauseReadsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(204, operations.UnpauseReadsAPIProblem$inboundSchema.optional()),
    M.jsonErr(400, errors.UnpauseReadsInputValidationProblem$inboundSchema, {
    ...
    M.json(
      "default",
      operations.UnpauseReadsAPIProblem$inboundSchema.optional(),
      { ctype: "application/problem+json" },
    ),
