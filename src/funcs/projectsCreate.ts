...
export async function projectsCreate(
  ...
  Result<
    ...
    | errors.CreateProjectInputValidationProblem
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateProjectRequestBody$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(422, errors.CreateProjectInputValidationProblem$inboundSchema, {
      ctype: "application/problem+json",
    }),
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.CreateProjectResponse$inboundSchema, {
      ctype: "application/problem+json",
    }),
