 ...
 * Get a destination
 */
export async function destinationsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDestinationRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.GetDestinationResponse$inboundSchema, {
      ctype: "application/problem+json",
    }),
