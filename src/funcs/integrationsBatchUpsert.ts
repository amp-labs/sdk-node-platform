...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BatchUpsertIntegrationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/projects/{projectIdOrName}/integrations:batch")(
    pathParams,
  );
  ...
  >(
    ...
    M.json(
      "default",
      operations.BatchUpsertIntegrationsResponse$inboundSchema,
      { ctype: "application/problem+json" },
    ),
