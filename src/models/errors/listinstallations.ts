 ...
 */
export const ListInstallationsIn = {
  Body: "body",
  Header: "header",
  Path: "path",
  Query: "query",
 ...
 * The location of the invalid input
 */
export type ListInstallationsIn = ClosedEnum<typeof ListInstallationsIn>;
...
export type ListInstallationsInputValidationIssue = {
   ...
   * The location of the invalid input
   */
  in?: ListInstallationsIn | undefined;
  /**
...
/** @internal */
export const ListInstallationsIn$inboundSchema: z.ZodNativeEnum<
  typeof ListInstallationsIn
> = z.nativeEnum(ListInstallationsIn);

/** @internal */
export const ListInstallationsIn$outboundSchema: z.ZodNativeEnum<
  typeof ListInstallationsIn
> = ListInstallationsIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ListInstallationsIn$ {
  /** @deprecated use `ListInstallationsIn$inboundSchema` instead. */
  export const inboundSchema = ListInstallationsIn$inboundSchema;
  /** @deprecated use `ListInstallationsIn$outboundSchema` instead. */
  export const outboundSchema = ListInstallationsIn$outboundSchema;
}
...
> = z.object({
  ...
  in: ListInstallationsIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: ListInstallationsIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
