 ...
 */
export const ListIntegrationsIn = {
  Body: "body",
  Header: "header",
  Path: "path",
  Query: "query",
 ...
 * The location of the invalid input
 */
export type ListIntegrationsIn = ClosedEnum<typeof ListIntegrationsIn>;
...
export type ListIntegrationsInputValidationIssue = {
   ...
   * The location of the invalid input
   */
  in?: ListIntegrationsIn | undefined;
  /**
...
/** @internal */
export const ListIntegrationsIn$inboundSchema: z.ZodNativeEnum<
  typeof ListIntegrationsIn
> = z.nativeEnum(ListIntegrationsIn);

/** @internal */
export const ListIntegrationsIn$outboundSchema: z.ZodNativeEnum<
  typeof ListIntegrationsIn
> = ListIntegrationsIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ListIntegrationsIn$ {
  /** @deprecated use `ListIntegrationsIn$inboundSchema` instead. */
  export const inboundSchema = ListIntegrationsIn$inboundSchema;
  /** @deprecated use `ListIntegrationsIn$outboundSchema` instead. */
  export const outboundSchema = ListIntegrationsIn$outboundSchema;
}
...
> = z.object({
  ...
  in: ListIntegrationsIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: ListIntegrationsIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
