 ...
 */
export const DeleteProviderAppIn = {
  Body: "body",
  Header: "header",
  Path: "path",
  Query: "query",
 ...
 * The location of the invalid input
 */
export type DeleteProviderAppIn = ClosedEnum<typeof DeleteProviderAppIn>;
...
export type DeleteProviderAppInputValidationIssue = {
   ...
   * The location of the invalid input
   */
  in?: DeleteProviderAppIn | undefined;
  /**
...
/** @internal */
export const DeleteProviderAppIn$inboundSchema: z.ZodNativeEnum<
  typeof DeleteProviderAppIn
> = z.nativeEnum(DeleteProviderAppIn);

/** @internal */
export const DeleteProviderAppIn$outboundSchema: z.ZodNativeEnum<
  typeof DeleteProviderAppIn
> = DeleteProviderAppIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace DeleteProviderAppIn$ {
  /** @deprecated use `DeleteProviderAppIn$inboundSchema` instead. */
  export const inboundSchema = DeleteProviderAppIn$inboundSchema;
  /** @deprecated use `DeleteProviderAppIn$outboundSchema` instead. */
  export const outboundSchema = DeleteProviderAppIn$outboundSchema;
}
...
> = z.object({
  ...
  in: DeleteProviderAppIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: DeleteProviderAppIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
