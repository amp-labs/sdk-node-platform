 ...
 * The location of the invalid input
 */
export type GetConnectionIn = ClosedEnum<typeof GetConnectionIn>;
...
/** @internal */
export const GetConnectionIn$inboundSchema: z.ZodNativeEnum<
  typeof GetConnectionIn
> = z.nativeEnum(GetConnectionIn);

/** @internal */
export const GetConnectionIn$outboundSchema: z.ZodNativeEnum<
  typeof GetConnectionIn
> = GetConnectionIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GetConnectionIn$ {
  /** @deprecated use `GetConnectionIn$inboundSchema` instead. */
  export const inboundSchema = GetConnectionIn$inboundSchema;
  /** @deprecated use `GetConnectionIn$outboundSchema` instead. */
  export const outboundSchema = GetConnectionIn$outboundSchema;
}
...
> = z.object({
  ...
  in: GetConnectionIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: GetConnectionIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
