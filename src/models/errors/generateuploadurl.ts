 ...
 */
export const GenerateUploadUrlIn = {
  Body: "body",
  Header: "header",
  Path: "path",
  Query: "query",
 ...
 * The location of the invalid input
 */
export type GenerateUploadUrlIn = ClosedEnum<typeof GenerateUploadUrlIn>;
...
export type GenerateUploadUrlInputValidationIssue = {
   ...
   * The location of the invalid input
   */
  in?: GenerateUploadUrlIn | undefined;
  /**
...
/** @internal */
export const GenerateUploadUrlIn$inboundSchema: z.ZodNativeEnum<
  typeof GenerateUploadUrlIn
> = z.nativeEnum(GenerateUploadUrlIn);

/** @internal */
export const GenerateUploadUrlIn$outboundSchema: z.ZodNativeEnum<
  typeof GenerateUploadUrlIn
> = GenerateUploadUrlIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GenerateUploadUrlIn$ {
  /** @deprecated use `GenerateUploadUrlIn$inboundSchema` instead. */
  export const inboundSchema = GenerateUploadUrlIn$inboundSchema;
  /** @deprecated use `GenerateUploadUrlIn$outboundSchema` instead. */
  export const outboundSchema = GenerateUploadUrlIn$outboundSchema;
}
...
> = z.object({
  ...
  in: GenerateUploadUrlIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: GenerateUploadUrlIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
