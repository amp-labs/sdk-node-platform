 ...
 */
export const ListProviderAppsIn = {
  Body: "body",
  Header: "header",
  Path: "path",
  Query: "query",
 ...
 * The location of the invalid input
 */
export type ListProviderAppsIn = ClosedEnum<typeof ListProviderAppsIn>;
...
export type ListProviderAppsInputValidationIssue = {
   ...
   * The location of the invalid input
   */
  in?: ListProviderAppsIn | undefined;
  /**
...
/** @internal */
export const ListProviderAppsIn$inboundSchema: z.ZodNativeEnum<
  typeof ListProviderAppsIn
> = z.nativeEnum(ListProviderAppsIn);

/** @internal */
export const ListProviderAppsIn$outboundSchema: z.ZodNativeEnum<
  typeof ListProviderAppsIn
> = ListProviderAppsIn$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ListProviderAppsIn$ {
  /** @deprecated use `ListProviderAppsIn$inboundSchema` instead. */
  export const inboundSchema = ListProviderAppsIn$inboundSchema;
  /** @deprecated use `ListProviderAppsIn$outboundSchema` instead. */
  export const outboundSchema = ListProviderAppsIn$outboundSchema;
}
...
> = z.object({
  ...
  in: ListProviderAppsIn$inboundSchema.optional(),
...
> = z.object({
  ...
  context: z.record(z.any()).optional(),
  in: ListProviderAppsIn$outboundSchema.optional(),
  name: z.string().optional(),
  value: z.any().optional(),
});
