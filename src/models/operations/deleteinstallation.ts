...
/** @internal */
export const DeleteInstallationRequest$inboundSchema: z.ZodType<
...
/** @internal */
export type DeleteInstallationRequest$Outbound = {
  projectIdOrName: string;
  integrationId: string;
  installationId: string;
};
...
/** @internal */
export const DeleteInstallationRequest$outboundSchema: z.ZodType<
  DeleteInstallationRequest$Outbound,
  z.ZodTypeDef,
  DeleteInstallationRequest
> = z.object({
  projectIdOrName: z.string(),
 ...
 */
export namespace DeleteInstallationRequest$ {
  /** @deprecated use `DeleteInstallationRequest$inboundSchema` instead. */
  export const inboundSchema = DeleteInstallationRequest$inboundSchema;
  /** @deprecated use `DeleteInstallationRequest$outboundSchema` instead. */
  export const outboundSchema = DeleteInstallationRequest$outboundSchema;
  /** @deprecated use `DeleteInstallationRequest$Outbound` instead. */
  export type Outbound = DeleteInstallationRequest$Outbound;
}

export function deleteInstallationRequestToJSON(
  deleteInstallationRequest: DeleteInstallationRequest,
): string {
  return JSON.stringify(
    DeleteInstallationRequest$outboundSchema.parse(deleteInstallationRequest),
  );
}

export function deleteInstallationRequestFromJSON(
  jsonString: string,
): SafeParseResult<DeleteInstallationRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeleteInstallationRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeleteInstallationRequest' from JSON`,
  );
}
